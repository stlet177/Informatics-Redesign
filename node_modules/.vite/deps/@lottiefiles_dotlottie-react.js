...
var N3 = 4;
var G3 = (() => {
  var c = typeof document < "u" ? document.currentScript?.src : void 0;
  return function(i = {}) {
    ...
    var r1 = 0, m1 = null;
    function O1(t) {
      throw r.onAbort?.(t), t = "Aborted(" + t + ")", K(t), X = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), w(t), t;
    }
    ...
    var P2 = (t) => {
      ...
      throw f1 = t, J1 || 0 < n2 || (r.onExit?.(t), X = true), new p2(t);
    }, I3 = (t) => {
      if (!X) try {
        if (t(), !(J1 || 0 < n2)) try {
          f1 = t = f1, k2(t);
...
` + s.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    (async function() {
      function t(s) {
        return C = s.exports, e1 = C.da, p1(), W = C.ga, P1.unshift(C.ea), r1--, r.monitorRunDependencies?.(r1), r1 == 0 && m1 && (s = m1, m1 = null, s()), C;
      }
      r1++, r.monitorRunDependencies?.(r1);
      var e = { a: P3 };
    ...
    function U2() {
      function t() {
        if (!z1 && (z1 = true, r.calledRun = true, !X)) {
          if (V1(P1), l(r), r.onRuntimeInitialized?.(), r.postRun) for (typeof r.postRun == "function" && (r.postRun = [r.postRun]); r.postRun.length; ) {
...
var J2 = class {
  ...
  dispatch(c) {
    this._eventListeners.get(c.type)?.forEach((i) => i(c));
  }
...
var j = class {
  ...
  static observe(c, i) {
    this._initializeObserver(), !this._observedCanvases.has(c) && (this._observedCanvases.set(c, i), this._observer?.observe(c));
  }
  static unobserve(c) {
    this._observer?.unobserve(c), this._observedCanvases.delete(c), this._observedCanvases.size === 0 && (this._observer?.disconnect(), this._observer = null);
  }
};
...
var N = class {
  ...
  static observe(c, i) {
    this._initializeObserver(), !this._observedCanvases.has(c) && (this._observedCanvases.set(c, [i, 0]), this._observer?.observe(c));
  }
  static unobserve(c) {
    ...
    this._observer?.unobserve(c), this._observedCanvases.delete(c), !this._observedCanvases.size && this._observer && (this._observer.disconnect(), this._observer = null);
  }
};
...
var K2 = class L {
  ...
  tween(i, a) {
    ...
    return this._dotLottieCore?.tween(i, a, l) ?? false;
  }
  tweenToMarker(i, a) {
    if (!L._wasmModule) return false;
    let r = [0, 0, 1, 1], l = new L._wasmModule.VectorFloat();
    for (let w of r) l.push_back(w);
    return this._dotLottieCore?.tweenToMarker(i, a, l) ?? false;
  }
  animationSize() {
    let i = this._dotLottieCore?.animationSize().get(0) ?? 0, a = this._dotLottieCore?.animationSize().get(1) ?? 0;
    return { width: i, height: a };
  }
  getLayerBoundingBox(i) {
    let a = this._dotLottieCore?.getLayerBounds(i);
  ...
  static transformThemeToLottieSlots(i, a) {
    return L._wasmModule?.transformThemeToLottieSlots(i, a) ?? "";
  }
  ...
  stateMachineStart() {
    ...
    if (this._stateMachineConfig) {
      ...
      if (r && typeof r.requireUserInteraction == "boolean" && (i.requireUserInteraction = r.requireUserInteraction), r?.whitelist) {
  ...
  stateMachineOverrideState(i, a = false) {
    return this._dotLottieCore?.stateMachineOverrideCurrentState(i, a) ?? false;
  }
  stateMachineGet(i) {
  ...
  stateMachineSetBooleanInput(i, a) {
    return this._dotLottieCore?.stateMachineSetBooleanInput(i, a) ?? false;
  }
  stateMachineSetNumericInput(i, a) {
    return this._dotLottieCore?.stateMachineSetNumericInput(i, a) ?? false;
  }
  stateMachineSetStringInput(i, a) {
    return this._dotLottieCore?.stateMachineSetStringInput(i, a) ?? false;
  }
  ...
  stateMachinePostClickEvent(i, a) {
    this._dotLottieCore?.stateMachinePostClickEvent(i, a);
  }
  stateMachinePostPointerUpEvent(i, a) {
    this._dotLottieCore?.stateMachinePostPointerUpEvent(i, a);
  }
  stateMachinePostPointerDownEvent(i, a) {
    this._dotLottieCore?.stateMachinePostPointerDownEvent(i, a);
  }
  stateMachinePostPointerMoveEvent(i, a) {
    this._dotLottieCore?.stateMachinePostPointerMoveEvent(i, a);
  }
  stateMachinePostPointerEnterEvent(i, a) {
    this._dotLottieCore?.stateMachinePostPointerEnterEvent(i, a);
  }
  stateMachinePostPointerExitEvent(i, a) {
    this._dotLottieCore?.stateMachinePostPointerExitEvent(i, a);
  }
  _onClick(i) {
    let a = x(i);
...
var f2 = class h1 {
  constructor(i) {
    ...
    this._worker = h1._workerManager.getWorker(a), h1._workerManager.assignAnimationToWorker(this._id, a), h1._wasmUrl && this._sendMessage("setWasmUrl", { url: h1._wasmUrl }), this._create({ ...i, renderConfig: { ...i.renderConfig, devicePixelRatio: i.renderConfig?.devicePixelRatio || c1(), freezeOnOffscreen: i.renderConfig?.freezeOnOffscreen ?? true } }), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this));
  }
  ...
  async _create(i) {
    ...
    let { instanceId: r } = await this._sendMessage("create", { instanceId: this._id, config: { ...i, canvas: a }, ...j2(this._canvas, i.renderConfig?.devicePixelRatio || c1()) }, [a]);
...
var G1 = ({ animationId: c, autoplay: i, backgroundColor: a, className: r, createDotLottie: l, data: w, dotLottieRefCallback: R, layout: k, loop: t1, mode: P, playOnHover: _1, renderConfig: K, segment: U, speed: e1, src: X, style: f1, themeData: Q, themeId: S, useFrameInterpolation: G, workerId: n1, ...$ }) => {
  ...
  let P1 = (0, import_react.useCallback)((z) => {
    i1.current = z, z ? m.current = l({ ...s1.current, canvas: z }) : (m.current?.destroy(), m.current = null), v1.current?.(m.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    let z = (E1) => {
      _1 && (E1.type === "mouseenter" && m.current?.play(), E1.type === "mouseleave" && m.current?.pause());
    };
    return i1.current?.addEventListener("mouseenter", z), i1.current?.addEventListener("mouseleave", z), () => {
      i1.current?.removeEventListener("mouseenter", z), i1.current?.removeEventListener("mouseleave", z);
    };
  }, [_1]), (0, import_react.useEffect)(() => {
    m.current?.setSpeed(e1 ?? 1);
  }, [e1]), (0, import_react.useEffect)(() => {
    m.current?.setMode(P ?? "forward");
  }, [P]), (0, import_react.useEffect)(() => {
    m.current?.setLoop(t1 ?? false);
  }, [t1]), (0, import_react.useEffect)(() => {
    m.current?.setUseFrameInterpolation(G ?? true);
  }, [G]), (0, import_react.useEffect)(() => {
    typeof U?.[0] == "number" && typeof U[1] == "number" && m.current?.setSegment(U[0], U[1]);
  }, [U]), (0, import_react.useEffect)(() => {
    m.current?.setBackgroundColor(a ?? "");
  }, [a]), (0, import_react.useEffect)(() => {
    m.current?.setRenderConfig(K ?? {});
  }, [JSON.stringify(K)]), (0, import_react.useEffect)(() => {
    typeof w != "string" && typeof w != "object" || m.current?.load({ data: w, ...s1.current });
  }, [w]), (0, import_react.useEffect)(() => {
    typeof X == "string" && m.current?.load({ src: X, ...s1.current });
  }, [X]), (0, import_react.useEffect)(() => {
    m.current?.setMarker($.marker ?? "");
  }, [$.marker]), (0, import_react.useEffect)(() => {
    m.current?.loadAnimation(c ?? "");
  }, [c]), (0, import_react.useEffect)(() => {
    typeof S == "string" && m.current?.setTheme(S);
  }, [S]), (0, import_react.useEffect)(() => {
    m.current?.setThemeData(Q ?? "");
  }, [Q]), (0, import_react.useEffect)(() => {
    m.current?.setLayout(k ?? {});
  }, [k?.fit, k?.align && k.align[0], k?.align && k.align[1]]), (0, import_jsx_runtime.jsx)("div", { className: r, ...!r && { style: { width: "100%", height: "100%", lineHeight: 0, ...f1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: P1, style: { width: "100%", height: "100%" }, ...$ }) });
};
var e0 = (c) => new H1(c);

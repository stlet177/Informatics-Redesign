...
var G3 = (() => {
  ...
  return function(i = {}) {
    var a, r = i, l, w, R = new Promise((t, e) => {
      l = t, w = e;
    }), k = Object.assign({}, r), t1 = "./this.program", P = "", _1;
    typeof document < "u" && document.currentScript && (P = document.currentScript.src), c && (P = c), P.startsWith("blob:") ? P = "" : P = P.substr(0, P.replace(/[?#].*/, "").lastIndexOf("/") + 1), _1 = async (t) => {
      if (t = await fetch(t, { credentials: "same-origin" }), t.ok) return t.arrayBuffer();
      throw Error(t.status + " : " + t.url);
    };
    var K = r.printErr || console.error.bind(console);
    Object.assign(r, k), k = null, r.thisProgram && (t1 = r.thisProgram);
    var U = r.wasmBinary, e1, X = false, f1, Q, S, G, n1, $, m, i1, v1;
    function p1() {
      var t = e1.buffer;
      r.HEAP8 = Q = new Int8Array(t), r.HEAP16 = G = new Int16Array(t), r.HEAPU8 = S = new Uint8Array(t), r.HEAPU16 = n1 = new Uint16Array(t), r.HEAP32 = $ = new Int32Array(t), r.HEAPU32 = m = new Uint32Array(t), r.HEAPF32 = i1 = new Float32Array(t), r.HEAPF64 = v1 = new Float64Array(t);
    }
    var s1 = [], P1 = [], z = [];
    function E1() {
    ...
    function O1(t) {
      var _a2;
      throw (_a2 = r.onAbort) == null ? void 0 : _a2.call(r, t), t = "Aborted(" + t + ")", K(t), X = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), w(t), t;
    }
    var v2 = (t) => t.startsWith("data:application/octet-stream;base64,"), A1;
    async function Q2(t) {
      if (!U) try {
        var e = await _1(t);
    ...
    async function Y2(t, e) {
      try {
        ...
        K(`failed to asynchronously prepare wasm: ${s}`), O1(s);
      }
    }
    async function Z2(t) {
      var e = A1;
      if (!U && typeof WebAssembly.instantiateStreaming == "function" && !v2(e) && typeof fetch == "function") try {
        var n = fetch(e, { credentials: "same-origin" });
        return await WebAssembly.instantiateStreaming(n, t);
      } catch (s) {
        K(`wasm streaming compile failed: ${s}`), K("falling back to ArrayBuffer instantiation");
      }
      return Y2(e, t);
    }
    class p2 {
    ...
    }, J1 = r.noExitRuntime || true, m2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, D1 = (t = 0, e = NaN) => {
      var n = S, s = t + e;
      for (e = t; n[e] && !(e >= s); ) ++e;
    ...
    var d1 = {}, o1 = {}, F1 = {}, M1, a1 = (t, e, n) => {
      function s(d) {
        if (d = n(d), d.length !== t.length) throw new M1("Mismatched type converter count");
        for (var _ = 0; _ < t.length; ++_) B(t[_], d[_]);
      }
      t.forEach((d) => F1[d] = e);
      var o = Array(e.length), h = [], u = 0;
      e.forEach((d, _) => {
        o1.hasOwnProperty(d) ? o[_] = o1[d] : (h.push(d), d1.hasOwnProperty(d) || (d1[d] = []), d1[d].push(() => {
          o[_] = o1[d], ++u, u === h.length && s(o);
        }));
      }), h.length === 0 && s(o);
    }, L2, O = (t) => {
      for (var e = ""; S[t]; ) e += L2[S[t++]];
      return e;
    }, g;
    function e3(t, e, n = {}) {
      var s = e.name;
      if (!t) throw new g(`type "${s}" must have a positive integer typeid pointer`);
      if (o1.hasOwnProperty(t)) {
        if (n.hb) return;
        throw new g(`Cannot register type '${s}' twice`);
      }
      o1[t] = e, delete F1[t], d1.hasOwnProperty(t) && (e = d1[t], delete d1[t], e.forEach((o) => o()));
    }
    function B(t, e, n = {}) {
      return e3(t, e, n);
    }
    var K1 = (t) => {
      ...
      if (!e.Da || !e.Ca) throw new M1("makeClassHandle requires ptr and ptrType");
      if (!!e.Ha != !!e.Fa) throw new M1("Both smartPtrType and smartPtr must be specified");
      return e.count = { value: 1 }, w1(Object.create(t, { Aa: { value: e, writable: true } }));
    }, w1 = (t) => typeof FinalizationRegistry > "u" ? (w1 = (e) => e, t) : (X1 = new FinalizationRegistry((e) => {
    ...
    var y1 = (t, e) => Object.defineProperty(e, "name", { value: t }), C2 = (t, e, n) => {
      if (t[e].Ea === void 0) {
        var s = t[e];
        t[e] = function(...o) {
          if (!t[e].Ea.hasOwnProperty(o.length)) throw new g(`Function '${n}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].Ea})!`);
          return t[e].Ea[o.length].apply(this, o);
        }, t[e].Ea = [], t[e].Ea[s.Na] = s;
      }
    }, Q1 = (t, e, n) => {
      if (r.hasOwnProperty(t)) {
        if (n === void 0 || r[t].Ea !== void 0 && r[t].Ea[n] !== void 0) throw new g(`Cannot register public name '${t}' twice`);
        if (C2(r, t, t), r[t].Ea.hasOwnProperty(n)) throw new g(`Cannot register multiple overloads of a function with the same number of arguments (${n})!`);
        r[t].Ea[n] = e;
      } else r[t] = e, r[t].Na = n;
    }, n3 = (t) => {
    ...
    var Y1 = (t, e, n) => {
      for (; e !== n; ) {
        if (!e.Qa) throw new g(`Expected null or instance of ${n.name}, got an instance of ${e.name}`);
        t = e.Qa(t), e = e.Ga;
      }
      return t;
    };
    function r3(t, e) {
      ...
      if (!e.Aa) throw new g(`Cannot pass "${a2(e)}" as a ${this.name}`);
    ...
    function o3(t, e) {
      ...
      if (!e || !e.Aa) throw new g(`Cannot pass "${a2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
        ...
        switch (this.ob) {
          ...
          case 2:
            if (e.Aa.Ha === this) n = e.Aa.Fa;
              ...
              var s = e.clone();
              n = this.kb(n, x1(() => s.delete())), t !== null && t.push(this.Ka, n);
            }
            break;
          default:
    ...
    function C1(t, e, n, s, o, h, u, d, _, v, f) {
    ...
    var b2 = (t, e, n) => {
      if (!r.hasOwnProperty(t)) throw new M1("Replacing nonexistent public symbol");
      r[t].Ea !== void 0 && n !== void 0 ? r[t].Ea[n] = e : (r[t] = e, r[t].Na = n);
    }, W, c3 = (t, e, n = []) => (t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, r["dynCall_" + t])(e, ...n)) : e = W.get(e)(...n), e), d3 = (t, e) => (...n) => c3(t, e, n), A = (t, e) => {
      t = O(t);
      var n = t.includes("j") ? d3(t, e) : W.get(e);
      if (typeof n != "function") throw new g(`unknown function pointer with signature ${t}: ${e}`);
      return n;
    }, I2, S2 = (t) => {
      t = W2(t);
      var e = O(t);
      ...
      function n(h) {
        o[h] || o1[h] || (F1[h] ? F1[h].forEach(n) : (s.push(h), o[h] = true));
      }
      var s = [], o = {};
      throw e.forEach(n), new I2(`${t}: ` + s.map(S2).join([", "]));
    }, Z1 = (t, e) => {
      for (var n = [], s = 0; s < t; s++) n.push(m[e + 4 * s >> 2]);
      return n;
    };
    function u3(t) {
    ...
    function t2(t, e, n, s, o) {
      ...
      return y1(t, function(...F) {
        if (y.length = 0, M.length = u ? 2 : 1, M[0] = o, u) {
          var b = e[1].toWireType(y, this);
          M[1] = b;
        }
        for (var I = 0; I < v; ++I) f[I] = e[I + 2].toWireType(y, F[I]), M.push(f[I]);
        if (F = s(...M), d) q1(y);
        else for (I = u ? 1 : 2; I < e.length; I++) {
          var H = I === 1 ? b : f[I - 2];
          e[I].Ja !== null && e[I].Ja(H);
        }
    ...
    var P2 = (t) => {
      ...
      var e = u1(t);
      return i2(t), e;
    }, toWireType: (t, e) => x1(e), Ia: 8, readValueFromPointer: L1, Ja: null }, l3 = (t, e, n) => {
      switch (e) {
        case 1:
          return n ? function(s) {
            return this.fromWireType(Q[s]);
          } : function(s) {
            return this.fromWireType(S[s]);
          };
        case 2:
          return n ? function(s) {
            return this.fromWireType(G[s >> 1]);
          } : function(s) {
      ...
      var n = o1[t];
      if (n === void 0) throw t = `${e} has unknown type ${S2(t)}`, new g(t);
      return n;
    }, a2 = (t) => {
      ...
      switch (e) {
        case 4:
          return function(n) {
            return this.fromWireType(i1[n >> 2]);
          };
        case 8:
          return function(n) {
            return this.fromWireType(v1[n >> 3]);
          };
        default:
      ...
      switch (e) {
        case 1:
          return n ? (s) => Q[s] : (s) => S[s];
        case 2:
          return n ? (s) => G[s >> 1] : (s) => n1[s >> 1];
        case 4:
          return n ? (s) => $[s >> 2] : (s) => m[s >> 2];
        default:
          throw new TypeError(`invalid integer width (${e}): ${t}`);
      }
      ...
      if (n <<= 1, 32 < n - t && O2) return O2.decode(S.subarray(t, n));
      for (n = "", s = 0; !(s >= e / 2); ++s) {
        var o = G[t + 2 * s >> 1];
        if (o == 0) break;
      ...
      for (var o = 0; o < n; ++o) G[e >> 1] = t.charCodeAt(o), e += 2;
      return G[e >> 1] = 0, e - s;
      ...
      var s = [];
      return t = t.toWireType(s, n), s.length && (m[e >> 2] = x1(s)), t;
    }, s2 = [], y3 = (t) => {
      var e = s2.length;
      return s2.push(t), e;
    }, C3 = (t, e) => {
      for (var n = Array(t), s = 0; s < t; ++s) n[s] = U1(m[e + 4 * s >> 2], "parameter " + s);
      return n;
    }, b3 = Reflect.construct, b1 = {}, D2 = (t) => {
      if (!(t instanceof p2 || t == "unwind")) throw t;
    }, k2 = (t) => {
      var _a2;
      throw f1 = t, J1 || 0 < n2 || ((_a2 = r.onExit) == null ? void 0 : _a2.call(r, t), X = true), new p2(t);
    }, I3 = (t) => {
      if (!X) try {
        if (t(), !(J1 || 0 < n2)) try {
          f1 = t = f1, k2(t);
      ...
      if (!o2) {
        var t = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: t1 || "./this.program" }, e;
    ...
    M1 = r.InternalError = class extends Error {
      constructor(t) {
        super(t), this.name = "InternalError";
      }
    };
    for (var R2 = Array(256), $1 = 0; 256 > $1; ++$1) R2[$1] = String.fromCharCode($1);
    L2 = R2, g = r.BindingError = class extends Error {
      constructor(t) {
        super(t), this.name = "BindingError";
      }
    }, Object.assign(R1.prototype, { isAliasOf: function(t) {
      if (!(this instanceof R1 && t instanceof R1)) return false;
      ...
      var t = w1, e = Object, n = e.create, s = Object.getPrototypeOf(this), o = this.Aa;
      ...
      if (this.Aa.Ca || K1(this), this.Aa.Oa && !this.Aa.Pa) throw new g("Object already scheduled for deletion");
      M2(this);
      var t = this.Aa;
    ...
    } }), Object.assign(C1.prototype, { cb(t) {
      return this.Ya && (t = this.Ya(t)), t;
    }, Wa(t) {
      var _a2;
      (_a2 = this.Ka) == null ? void 0 : _a2.call(this, t);
    }, Ia: 8, readValueFromPointer: L1, fromWireType: function(t) {
      function e() {
        return this.Sa ? T1(this.Ba.Ma, { Da: this.ib, Ca: n, Ha: this, Fa: t }) : T1(this.Ba.Ma, { Da: this, Ca: t });
      }
      var n = this.cb(t);
      ...
      return o === null ? e.call(this) : this.Sa ? T1(s.Ba.Ma, { Da: s, Ca: o, Ha: this, Fa: t }) : T1(s.Ba.Ma, { Da: s, Ca: o });
    } }), I2 = r.UnboundTypeError = ((t, e) => {
      var n = y1(e, function(s) {
...
` + s.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    })(Error, "UnboundTypeError"), Y.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), r.count_emval_handles = () => Y.length / 2 - 5 - e2.length;
    var P3 = { c: (t, e, n, s) => O1(`Assertion failed: ${t ? D1(t) : ""}, at: ` + [e ? e ? D1(e) : "" : "unknown filename", n, s ? s ? D1(s) : "" : "unknown function"]), j: (t, e, n) => {
      var s = new t3(t);
      throw m[s.Ca + 16 >> 2] = 0, m[s.Ca + 4 >> 2] = e, m[s.Ca + 8 >> 2] = n, g2 = t, g2;
    }, P: () => {
    }, M: () => {
    }, N: () => {
    }, R: function() {
      ...
      a1([t], h, (u) => {
        ...
        return o.forEach((_, v) => {
          var f = u[v], M = _.eb, y = _.fb, F = u[v + o.length], b = _.lb, I = _.nb;
          d[_.ab] = { read: (H) => f.fromWireType(M(y, H)), write: (H, I1) => {
            var T = [];
            b(I, H, F.toWireType(T, I1)), q1(T);
          } };
        ...
        }, Ia: 8, readValueFromPointer: L1, Ja: s }];
      });
    }, F: () => {
    }, _: (t, e, n, s) => {
      e = O(e), B(t, { name: e, fromWireType: function(o) {
        return !!o;
      ...
      f = O(f), h = A(o, h), d && (d = A(u, d)), v && (v = A(_, v)), y = A(M, y);
      var F = n3(f);
      Q1(F, function() {
        W1(`Cannot construct ${f} due to unbound types`, [s]);
      }), a1([t, e, n], s ? [s] : [], (b) => {
        if (b = b[0], s) var I = b.Ba, H = I.Ma;
        else H = R1.prototype;
        b = y1(f, function(...c2) {
          if (Object.getPrototypeOf(this) !== I1) throw new g("Use 'new' to construct " + f);
          if (T.La === void 0) throw new g(f + " has no accessible constructor");
          var $2 = T.La[c2.length];
          if ($2 === void 0) throw new g(`Tried to invoke ctor of ${f} with invalid number of parameters (${c2.length}) - expected (${Object.keys(T.La).toString()}) parameters instead!`);
          return $2.apply(this, c2);
        });
        var I1 = Object.create(H, { constructor: { value: b } });
        b.prototype = I1;
        var T = new s3(f, b, I1, y, I, h, d, v);
        if (T.Ga) {
          var S1;
          (S1 = T.Ga).Va ?? (S1.Va = []), T.Ga.Va.push(T);
        }
        return I = new C1(f, T, true, false, false), S1 = new C1(f + "*", T, false, false, false), H = new C1(f + " const*", T, false, true, false), y2[t] = { pointerType: S1, Za: H }, b2(F, b), [I, S1, H];
      });
    }, r: (t, e, n, s, o, h) => {
      var u = Z1(e, n);
      o = A(s, o), a1([], [t], (d) => {
        ...
        return d.Ba.La[e - 1] = () => {
          W1(`Cannot construct ${d.name} due to unbound types`, u);
        }, a1([], u, (v) => (v.splice(1, 0, null), d.Ba.La[e - 1] = t2(_, v, null, o, h), [])), [];
      });
    }, d: (t, e, n, s, o, h, u, d) => {
      var _ = Z1(n, s);
      e = O(e), e = P2(e), h = A(o, h), a1([], [t], (v) => {
        function f() {
          W1(`Cannot call ${M} due to unbound types`, _);
        }
        v = v[0];
        var M = `${v.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), d && v.Ba.jb.push(e);
        var y = v.Ba.Ma, F = y[e];
        return F === void 0 || F.Ea === void 0 && F.className !== v.name && F.Na === n - 2 ? (f.Na = n - 2, f.className = v.name, y[e] = f) : (C2(y, e, M), y[e].Ea[n - 2] = f), a1([], _, (b) => (b = t2(M, b, v, h, u), y[e].Ea === void 0 ? (b.Na = n - 2, y[e] = b) : y[e].Ea[n - 2] = b, [])), [];
      });
    }, Y: (t) => B(t, E2), D: (t, e, n, s) => {
      function o() {
      }
      e = O(e), o.values = {}, B(t, { name: e, constructor: o, fromWireType: function(h) {
        return this.constructor.values[h];
      }, toWireType: (h, u) => u.value, Ia: 8, readValueFromPointer: l3(e, n, s), Ja: null }), Q1(e, o);
    }, l: (t, e, n) => {
      var s = U1(t, "enum");
      e = O(e), t = s.constructor, s = Object.create(s.constructor.prototype, { value: { value: n }, constructor: { value: y1(`${s.name}_${e}`, function() {
      }) } }), t.values[n] = s, t[e] = s;
    }, A: (t, e, n) => {
      e = O(e), B(t, { name: e, fromWireType: (s) => s, toWireType: (s, o) => o, Ia: 8, readValueFromPointer: _3(e, n), Ja: null });
    }, v: (t, e, n, s, o, h) => {
      var u = Z1(e, n);
      t = O(t), t = P2(t), o = A(s, o), Q1(t, function() {
        W1(`Cannot call ${t} due to unbound types`, u);
      }, e - 1), a1([], u, (d) => (b2(t, t2(t, [d[0], null].concat(d.slice(1)), null, o, h), e - 1), []));
    }, n: (t, e, n, s, o) => {
      if (e = O(e), o === -1 && (o = 4294967295), o = (d) => d, s === 0) {
        var h = 32 - 8 * n;
        o = (d) => d << h >>> h;
      }
      ...
      B(t, { name: e, fromWireType: o, toWireType: u, Ia: 8, readValueFromPointer: f3(e, n, s !== 0), Ja: null });
    }, g: (t, e, n) => {
      function s(h) {
        return new o(Q.buffer, m[h + 4 >> 2], m[h >> 2]);
      }
      var o = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][e];
      n = O(n), B(t, { name: n, fromWireType: s, Ia: 8, readValueFromPointer: s }, { hb: true });
    }, q: (t) => {
      B(t, v3);
    }, u: (t, e, n, s, o, h, u, d, _, v, f, M) => {
      n = O(n), h = A(o, h), d = A(u, d), v = A(_, v), M = A(f, M), a1([t], [e], (y) => (y = y[0], [new C1(n, y.Ba, false, false, true, y, s, h, d, v, M)]));
    }, Z: (t, e) => {
      e = O(e), B(t, { name: e, fromWireType: function(n) {
        for (var s = m[n >> 2], o = n + 4, h, u = o, d = 0; d <= s; ++d) {
          var _ = o + d;
          (d == s || S[_] == 0) && (u = u ? D1(u, _ - u) : "", h === void 0 ? h = u : (h += "\0", h += u), u = _ + 1);
        }
        return Z(n), h;
      }, toWireType: function(n, s) {
        s instanceof ArrayBuffer && (s = new Uint8Array(s));
        var o, h = typeof s == "string";
        if (!(h || s instanceof Uint8Array || s instanceof Uint8ClampedArray || s instanceof Int8Array)) throw new g("Cannot pass non-string to std::string");
        if (h) for (var u = o = 0; u < s.length; ++u) {
          var d = s.charCodeAt(u);
          127 >= d ? o++ : 2047 >= d ? o += 2 : 55296 <= d && 57343 >= d ? (o += 4, ++u) : o += 3;
        }
        else o = s.length;
        if (u = h2(4 + o + 1), d = u + 4, m[u >> 2] = o, h) g1(s, d, o + 1);
        else if (h) for (h = 0; h < o; ++h) {
          var _ = s.charCodeAt(h);
          if (255 < _) throw Z(d), new g("String has UTF-16 code units that do not fit in 8 bits");
          S[d + h] = _;
        }
        else for (h = 0; h < o; ++h) S[d + h] = s[h];
        return n !== null && n.push(Z, u), u;
      }, Ia: 8, readValueFromPointer: L1, Ja(n) {
        Z(n);
      } });
    }, y: (t, e, n) => {
      if (n = O(n), e === 2) var s = p3, o = m3, h = g3, u = (d) => n1[d >> 1];
      else e === 4 && (s = L3, o = M3, h = w3, u = (d) => m[d >> 2]);
      B(t, { name: n, fromWireType: (d) => {
        for (var _ = m[d >> 2], v, f = d + 4, M = 0; M <= _; ++M) {
          var y = d + 4 + M * e;
          (M == _ || u(y) == 0) && (f = s(f, y - f), v === void 0 ? v = f : (v += "\0", v += f), f = y + e);
        }
        return Z(d), v;
      }, toWireType: (d, _) => {
        if (typeof _ != "string") throw new g(`Cannot pass non-string to C++ string type ${n}`);
        var v = h(_), f = h2(4 + v + e);
        return m[f >> 2] = v / e, o(_, f + 4, v + e), d !== null && d.push(Z, f), f;
      }, Ia: 8, readValueFromPointer: L1, Ja(d) {
        Z(d);
      } });
    }, x: (t, e, n, s, o, h) => {
      k1[t] = { name: O(e), Ua: A(n, s), Ka: A(o, h), Xa: [] };
    }, i: (t, e, n, s, o, h, u, d, _, v) => {
      k1[t].Xa.push({ ab: O(e), gb: n, eb: A(s, o), fb: h, mb: u, lb: A(d, _), nb: v });
    }, $: (t, e) => {
      e = O(e), B(t, { pb: true, name: e, Ia: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, K: () => {
      J1 = false, n2 = 0;
      ...
      throw 1 / 0;
    }, C: (t, e, n) => (t = u1(t), e = U1(e, "emval::as"), A2(e, n, t)), p: (t, e, n, s) => (t = s2[t], e = u1(e), t(null, e, n, s)), W: i2, E: (t, e) => (t = u1(t), e = u1(e), t == e), o: (t, e, n) => {
      var s = C3(t, e), o = s.shift();
      t--;
      var h = Array(t);
      return e = `methodCaller<(${s.map((u) => u.name).join(", ")}) => ${o.name}>`, y3(y1(e, (u, d, _, v) => {
      ...
      var e = u1(t);
      q1(e), i2(t);
    }, t: (t, e) => (t = U1(t, "_emval_take_value"), t = t.readValueFromPointer(e), x1(t)), G: (t, e) => {
      if (b1[t] && (clearTimeout(b1[t].id), delete b1[t]), !e) return 0;
      var n = setTimeout(() => {
        delete b1[t], I3(() => x2(t, performance.now()));
      }, e);
      return b1[t] = { id: n, qb: e }, 0;
    }, H: (t, e, n, s) => {
      var o = (/* @__PURE__ */ new Date()).getFullYear(), h = new Date(o, 0, 1).getTimezoneOffset();
      o = new Date(o, 6, 1).getTimezoneOffset(), m[t >> 2] = 60 * Math.max(h, o), $[e >> 2] = +(h != o), e = (u) => {
        var d = Math.abs(u);
        return `UTC${0 <= u ? "-" : "+"}${String(Math.floor(d / 60)).padStart(2, "0")}${String(d % 60).padStart(2, "0")}`;
      }, t = e(h), e = e(o), o < h ? (g1(t, n, 17), g1(e, s, 17)) : (g1(t, s, 17), g1(e, n, 17));
      ...
      for (var n = 1; 4 >= n; n *= 2) {
        ...
        t: {
          s = (Math.min(2147483648, 65536 * Math.ceil(Math.max(t, s) / 65536)) - e1.buffer.byteLength + 65535) / 65536 | 0;
          try {
            e1.grow(s), p1();
            var o = 1;
            break t;
      ...
      return F2().forEach((s, o) => {
        var h = e + n;
        for (o = m[t + 4 * o >> 2] = h, h = 0; h < s.length; ++h) Q[o++] = s.charCodeAt(h);
        Q[o] = 0, n += s.length + 1;
      }), 0;
    }, X: (t, e) => {
      var n = F2();
      m[t >> 2] = n.length;
      var s = 0;
      return n.forEach((o) => s += o.length + 1), m[e >> 2] = s, 0;
    }, S: () => 52, Q: () => 52, k: E3, f: k3, e: R3, B: O3, aa: T3, a: A3, b: F3, h: D3, s: W3, U: k2, L: (t, e) => (T2(S.subarray(t, t + e)), 0) }, C;
    (async function() {
      var _a2;
      function t(s) {
        var _a3;
        return C = s.exports, e1 = C.da, p1(), W = C.ga, P1.unshift(C.ea), r1--, (_a3 = r.monitorRunDependencies) == null ? void 0 : _a3.call(r, r1), r1 == 0 && m1 && (s = m1, m1 = null, s()), C;
      }
      r1++, (_a2 = r.monitorRunDependencies) == null ? void 0 : _a2.call(r, r1);
      var e = { a: P3 };
      if (r.instantiateWasm) try {
        return r.instantiateWasm(e, t);
      } catch (s) {
        K(`Module.instantiateWasm callback failed with error: ${s}`), w(s);
      }
      A1 ?? (A1 = v2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : r.locateFile ? r.locateFile("DotLottiePlayer.wasm", P) : P + "DotLottiePlayer.wasm");
      try {
        var n = await Z2(e);
    ...
    var h2 = (t) => (h2 = C.fa)(t), Z = (t) => (Z = C.ha)(t), W2 = (t) => (W2 = C.ia)(t), x2 = (t, e) => (x2 = C.ja)(t, e), V = (t, e) => (V = C.ka)(t, e), J = (t) => (J = C.la)(t), q = () => (q = C.ma)();
    ...
    function O3(t, e, n, s, o, h) {
      var u = q();
      try {
        return W.get(t)(e, n, s, o, h);
      } catch (d) {
        if (J(u), d !== d + 0) throw d;
        V(1, 0);
      }
    }
    function A3(t, e) {
    ...
    function U2() {
      function t() {
        var _a2;
        if (!z1 && (z1 = true, r.calledRun = true, !X)) {
          if (V1(P1), l(r), (_a2 = r.onRuntimeInitialized) == null ? void 0 : _a2.call(r), r.postRun) for (typeof r.postRun == "function" && (r.postRun = [r.postRun]); r.postRun.length; ) {
      ...
      if (!(0 < r1)) {
        if (r.preRun) for (typeof r.preRun == "function" && (r.preRun = [r.preRun]); r.preRun.length; ) E1();
        V1(s1), 0 < r1 || (r.setStatus ? (r.setStatus("Running..."), setTimeout(() => {
...
p(B1, "_ModulePromise", null), p(B1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${V2}@${G2}/dist/dotlottie-player.wasm`);
var J2 = class {
  constructor() {
...
p(j, "_observer", null), p(j, "_observedCanvases", /* @__PURE__ */ new Map());
var N = class {
  static _initializeObserver() {
    if (this._observer) return;
    let c = (i) => {
      i.forEach((a) => {
        ...
        this._observedCanvases.set(a.target, [l, R]);
      });
    };
...
function x(c) {
  ...
  if (i instanceof HTMLCanvasElement) {
    ...
    let r = i.width / a.width, l = i.height / a.height, w = (c.clientX - a.left) * r, R = (c.clientY - a.top) * l;
    return !Number.isFinite(w) || !Number.isFinite(R) || Number.isNaN(w) || Number.isNaN(R) ? null : { x: w, y: R };
  }
  return null;
}
function q2(c) {
...
var K2 = class L {
  ...
  get layout() {
    ...
    if (i) return { align: [i.align.get(0), i.align.get(1)], fit: (() => {
      ...
      switch (i.fit) {
        case ((_a2 = L._wasmModule) == null ? void 0 : _a2.Fit.Contain):
          return "contain";
        case ((_b = L._wasmModule) == null ? void 0 : _b.Fit.Cover):
          return "cover";
        case ((_c = L._wasmModule) == null ? void 0 : _c.Fit.Fill):
          return "fill";
        case ((_d = L._wasmModule) == null ? void 0 : _d.Fit.FitHeight):
          return "fit-height";
        case ((_e = L._wasmModule) == null ? void 0 : _e.Fit.FitWidth):
          return "fit-width";
        case ((_f = L._wasmModule) == null ? void 0 : _f.Fit.None):
          return "none";
        default:
          return "contain";
      }
  ...
  get mode() {
    ...
    return i === ((_b = L._wasmModule) == null ? void 0 : _b.Mode.Reverse) ? "reverse" : i === ((_c = L._wasmModule) == null ? void 0 : _c.Mode.Bounce) ? "bounce" : i === ((_d = L._wasmModule) == null ? void 0 : _d.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  _animationLoop() {
    ...
    try {
      (this._dotLottieCore.tick() || this._dotLottieCore.render()) && this._draw(), this._animationFrameId = this._frameManager.requestAnimationFrame(this._animationLoop.bind(this));
    } catch (i) {
  ...
  play() {
    this._dotLottieCore === null || !this.isLoaded || (this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), E && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !l1(this._canvas) && this.freeze());
  }
  pause() {
  ...
  destroy() {
    var _a, _b, _c, _d;
    this._stopAnimationLoop(), this._isStateMachineRunning = false, E && this._canvas instanceof HTMLCanvasElement && (j.unobserve(this._canvas), N.unobserve(this._canvas)), this._stateMachineObserverHandle && ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineUnsubscribe(this._stateMachineObserverHandle), this._stateMachineObserverHandle.delete(), this._stateMachineObserverHandle = null), this._stateMachineInternalMessageObserver && ((_b = this._dotLottieCore) == null ? void 0 : _b.stateMachineInternalUnsubscribe(this._stateMachineInternalMessageObserver), this._stateMachineInternalMessageObserver.delete(), this._stateMachineInternalMessageObserver = null), this._dotLottieObserverHandle && ((_c = this._dotLottieCore) == null ? void 0 : _c.unsubscribe(this._dotLottieObserverHandle), this._dotLottieObserverHandle.delete(), this._dotLottieObserverHandle = null), (_d = this._dotLottieCore) == null ? void 0 : _d.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  setSegment(i, a) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: l2([i, a], L._wasmModule) });
  }
  setMode(i) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: u2(i, L._wasmModule) });
  }
  setRenderConfig(i) {
    let { devicePixelRatio: a, freezeOnOffscreen: r, ...l } = i;
    this._renderConfig = { ...this._renderConfig, ...l, devicePixelRatio: a || c1(), freezeOnOffscreen: r ?? true }, E && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? N.observe(this._canvas, this) : N.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (j.observe(this._canvas, this), l1(this._canvas) || this.freeze()) : (j.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(i) {
    this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === i || this._dotLottieCore.loadAnimation(i, this._canvas.width, this._canvas.height) && this.resize();
  }
  setMarker(i) {
  ...
  setLayout(i) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: _2(i, L._wasmModule) });
  }
  setViewport(i, a, r, l) {
  ...
  tween(i, a) {
    ...
    let r = [0, 0, 1, 1], l = new L._wasmModule.VectorFloat();
    for (let w of r) l.push_back(w);
  ...
  static transformThemeToLottieSlots(i, a) {
    var _a;
    return ((_a = L._wasmModule) == null ? void 0 : _a.transformThemeToLottieSlots(i, a)) ?? "";
  }
  _setupStateMachineObservers() {
    ...
    }), i.setOnBooleanInputValueChange((r, l, w) => {
      this._eventManager.dispatch({ type: "stateMachineBooleanInputValueChange", inputName: r, newValue: w, oldValue: l });
    }), i.setOnNumericInputValueChange((r, l, w) => {
      this._eventManager.dispatch({ type: "stateMachineNumericInputValueChange", inputName: r, newValue: w, oldValue: l });
    }), i.setOnStringInputValueChange((r, l, w) => {
      this._eventManager.dispatch({ type: "stateMachineStringInputValueChange", inputName: r, newValue: w, oldValue: l });
    }), i.setOnInputFired((r) => {
    ...
    let a = new L._wasmModule.CallbackStateMachineInternalObserver();
    a.setOnMessage((r) => {
...
var f2 = class h1 {
  ...
  async _create(i) {
    ...
    let { instanceId: r } = await this._sendMessage("create", { instanceId: this._id, config: { ...i, canvas: a }, ...j2(this._canvas, ((_a = i.renderConfig) == null ? void 0 : _a.devicePixelRatio) || c1()) }, [a]);
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), E && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !l1(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setRenderConfig(i) {
    ...
    let { devicePixelRatio: a, freezeOnOffscreen: r, ...l } = i;
    await this._sendMessage("setRenderConfig", { instanceId: this._id, renderConfig: { ...this._dotLottieInstanceState.renderConfig, ...l, devicePixelRatio: a || c1(), freezeOnOffscreen: r ?? true } }), await this._updateDotLottieInstanceState(), E && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? N.observe(this._canvas, this) : N.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? (j.observe(this._canvas, this), l1(this._canvas) || await this.freeze()) : (j.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && await this.unfreeze()));
  }
  ...
  async resize() {
    if (!this._created) return;
    let { height: i, width: a } = j2(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || c1());
    await this._sendMessage("resize", { height: i, instanceId: this._id, width: a }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), h1._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), E && this._canvas instanceof HTMLCanvasElement && (j.unobserve(this._canvas), N.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async _sendMessage(i, a, r) {
    ...
    return this._worker.postMessage(l, r || []), new Promise((w, R) => {
      let k = (t1) => {
        let P = t1.data;
        P.id === l.id && (this._worker.removeEventListener("message", k), P.error ? R(new Error(`Failed to execute method ${i}: ${P.error}`)) : w(P.result));
      };
      this._worker.addEventListener("message", k);
    });
  }
  addEventListener(i, a) {
    this._eventManager.addEventListener(i, a);
...
var j1 = f2;
var G1 = ({ animationId: c, autoplay: i, backgroundColor: a, className: r, createDotLottie: l, data: w, dotLottieRefCallback: R, layout: k, loop: t1, mode: P, playOnHover: _1, renderConfig: K, segment: U, speed: e1, src: X, style: f1, themeData: Q, themeId: S, useFrameInterpolation: G, workerId: n1, ...$ }) => {
  let m = (0, import_react.useRef)(null), i1 = (0, import_react.useRef)(null), v1 = (0, import_react.useRef)(R), p1 = { speed: e1, mode: P, loop: t1, useFrameInterpolation: G, segment: U, backgroundColor: a, autoplay: i, themeId: S, workerId: n1, src: X, data: w, layout: k, renderConfig: K, animationId: c }, s1 = (0, import_react.useRef)(p1);
  v1.current = R, s1.current = p1;
  let P1 = (0, import_react.useCallback)((z) => {
    var _a, _b;
    i1.current = z, z ? m.current = l({ ...s1.current, canvas: z }) : ((_a = m.current) == null ? void 0 : _a.destroy(), m.current = null), (_b = v1.current) == null ? void 0 : _b.call(v1, m.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let z = (E1) => {
      var _a2, _b2;
      _1 && (E1.type === "mouseenter" && ((_a2 = m.current) == null ? void 0 : _a2.play()), E1.type === "mouseleave" && ((_b2 = m.current) == null ? void 0 : _b2.pause()));
    };
    return (_a = i1.current) == null ? void 0 : _a.addEventListener("mouseenter", z), (_b = i1.current) == null ? void 0 : _b.addEventListener("mouseleave", z), () => {
      var _a2, _b2;
      (_a2 = i1.current) == null ? void 0 : _a2.removeEventListener("mouseenter", z), (_b2 = i1.current) == null ? void 0 : _b2.removeEventListener("mouseleave", z);
    };
  }, [_1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setSpeed(e1 ?? 1);
  }, [e1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setMode(P ?? "forward");
  }, [P]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setLoop(t1 ?? false);
  }, [t1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setUseFrameInterpolation(G ?? true);
  }, [G]), (0, import_react.useEffect)(() => {
    var _a;
    typeof (U == null ? void 0 : U[0]) == "number" && typeof U[1] == "number" && ((_a = m.current) == null ? void 0 : _a.setSegment(U[0], U[1]));
  }, [U]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setBackgroundColor(a ?? "");
  }, [a]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setRenderConfig(K ?? {});
  }, [JSON.stringify(K)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof w != "string" && typeof w != "object" || ((_a = m.current) == null ? void 0 : _a.load({ data: w, ...s1.current }));
  }, [w]), (0, import_react.useEffect)(() => {
    var _a;
    typeof X == "string" && ((_a = m.current) == null ? void 0 : _a.load({ src: X, ...s1.current }));
  }, [X]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setMarker($.marker ?? "");
  }, [$.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.loadAnimation(c ?? "");
  }, [c]), (0, import_react.useEffect)(() => {
    var _a;
    typeof S == "string" && ((_a = m.current) == null ? void 0 : _a.setTheme(S));
  }, [S]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setThemeData(Q ?? "");
  }, [Q]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = m.current) == null ? void 0 : _a.setLayout(k ?? {});
  }, [k == null ? void 0 : k.fit, (k == null ? void 0 : k.align) && k.align[0], (k == null ? void 0 : k.align) && k.align[1]]), (0, import_jsx_runtime.jsx)("div", { className: r, ...!r && { style: { width: "100%", height: "100%", lineHeight: 0, ...f1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: P1, style: { width: "100%", height: "100%" }, ...$ }) });
};
var e0 = (c) => new H1(c);
var y0 = (c) => (0, import_jsx_runtime.jsx)(G1, { ...c, createDotLottie: e0 });
var a0 = (c) => new j1(c);
var P0 = (c) => (0, import_jsx_runtime.jsx)(G1, { ...c, createDotLottie: a0 });
var D0 = (c) => {
  j1.setWasmUrl(c), H1.setWasmUrl(c);
};
export {

  ...
  academic: [
    {
      ...
      usp: ["4 years", "SE/Cloud/Cyber tracks"],
      route: "#/programs/information-technology",
    ...
    },
    {
      ...
      usp: ["4 years", "Algorithms/AI focus"],
      route: "#/programs/computer-science",
      enrollmentLink: "#/contact",
    },
    {
      key: "is",
      ...
      usp: ["4 years", "IS/BA focus"],
      route: "#/programs/information-systems",
      enrollmentLink: "#/contact",
    },
    {
      key: "ba",
      title: "BS Business Administration (Business Analytics)",
      blurb: "Management + analytics: spreadsheets to dashboards to decisions.",
      usp: ["4 years", "Business Analytics"],
      route: "#/programs/business-administration",
      enrollmentLink: "#/contact",
    },
  ],
  certificates: [

      ...
      <section className="pt-24 md:pt-28 pb-10 relative overflow-hidden">
        ...
        <Container className="grid items-center gap-8 md:grid-cols-2">
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <motion.h1 variants={slideUp} className="mt-3 text-4xl md:text-5xl font-extrabold tracking-tight" style={{ color: BRAND_DARK }}>BS Business Administration (Business Analytics)</motion.h1>
            <motion.p variants={slideUp} className="mt-3 text-slate-700">Blend business fundamentals with data literacy. Turn raw data into insights and decisions using modern analytics tools and dashboards.</motion.p>
            <motion.div variants={slideUp} className="mt-5 flex flex-wrap gap-2 text-xs">
              ...
              <span className="rounded-full px-3 py-1 bg-slate-100" style={{ color: BRAND_DARK }}>Analytics-focused</span>
      ...
      <section className="py-12 md:py-16">
        <Container>
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }}>
            ...
            <motion.p variants={slideUp} className="mt-3 text-slate-700 max-w-3xl">The BSBA (Business Analytics) program covers finance, marketing, and operations while building strong analytics skills. Students learn to collect, transform, and visualize data to support strategic decisions.</motion.p>
          </motion.div>
        </Container>
      </section>
      ...
      <section className="py-12 md:py-16" style={{ background: BRAND_LIGHT }}>
        <Container>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {[
              { title: 'Business Fundamentals', desc: 'Accounting, finance, marketing, and operations.' },
              { title: 'Data Analytics', desc: 'Spreadsheets, SQL, and dashboarding for insights.' },
              { title: 'Decision Systems', desc: 'KPIs, forecasting, and data-informed management.' },
            ].map((s, i) => (
        ...
        <Container>
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }} className="mt-4 grid gap-3 md:grid-cols-2">
            {[
              ...
              'Marketing Analyst / Insights Analyst',

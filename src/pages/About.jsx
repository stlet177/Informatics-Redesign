...
import { Globe, GraduationCap, Briefcase, Users, Award, Target, Heart, Lightbulb, Shield, TrendingUp, Mail, Phone, MapPin, Calendar, Menu, History } from "lucide-react";
...
export default function About() {
  ...
  const sidebarItems = [
    { text: "Where it all began", icon: History },
    { text: "The future we're building", icon: Target },
    { text: "Leadership and Legacy", icon: Users },
    { text: "Our Achievements", icon: Award },
    { text: "Campuses", icon: MapPin },
    { text: "Community Engagements", icon: Heart },
    ...
    <>
      ...
      <main className={`pt-12 md:pt-16 flex min-h-screen bg-white`}>
        ...
        <motion.aside
          ...
          className="hidden md:flex fixed left-0 top-16 w-48 h-screen bg-gradient-to-b from-blue-50 to-blue-100 border-r border-gray-300 p-4 overflow-y-auto shadow-xl"
        >
          <motion.nav
            initial="hidden"
            animate="visible"
          ...
          >
            {sidebarItems.map((item, index) => (
              <motion.a
                ...
                className="flex items-center gap-3 text-gray-800 hover:text-blue-700 font-medium py-2 px-3 rounded-lg hover:bg-blue-50 transition-all duration-300"
              >
        ...
        <div className="flex-1 md:ml-48 relative min-h-[calc(100vh-4rem)] p-6 max-w-full overflow-x-hidden">
          ...
          {/* Existing content */}
          <motion.section {...fadeInUp} className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
            {/* Background Image */}
            <div
            ...
            <Container className="relative z-10">
              <div className="text-center max-w-6xl mx-auto px-4">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black mb-6 text-white leading-tight">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <a
                    href="#/programs"
                    className="group inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3 md:px-8 md:py-4 text-white font-bold text-base md:text-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:-translate-y-1 border border-blue-500/50"
                  >
                  ...
                  <a
                    href="#/campuses"
                    className="group inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3 md:px-8 md:py-4 text-white font-bold text-base md:text-lg border-2 border-white/30 hover:border-white/50 bg-white/10 hover:bg-white/20 backdrop-blur-xl shadow-2xl transition-all duration-300 hover:-translate-y-1"
                  >
                    <MapPin size={20} />
                    Find Campus
                  </a>
          ...
          <section className="py-16 md:py-20" id="the-future-we're-building" style={{ background: `linear-gradient(135deg, ${BRAND_LIGHT} 0%, #e2e8f0 100%)` }}>
            <motion.div {...fadeInUp}>
              <Container>
                <div className="max-w-7xl mx-auto">
          ...
          <section className="py-16 md:py-20 bg-gradient-to-b from-slate-50 to-white" id="leadership-and-legacy">
            <motion.div {...fadeInUp}>
              <Container>
                <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-12">
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-12">
                      {milestones.map((milestone, index) => (
                        <div key={index} className={`relative flex items-start gap-4 md:gap-8 ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                          {/* Timeline Dot */}
          ...
          {/* Core Values */}
          <section className="py-16 md:py-20" style={{ background: `linear-gradient(135deg, ${BRAND_LIGHT} 0%, #e2e8f0 100%)` }} id="our-achievements">
            <motion.div {...fadeInUp}>
              <Container>
                <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-12">
          ...
          <section className="py-16 md:py-20 bg-gradient-to-br from-slate-50 to-white" id="campuses">
            <motion.div {...fadeInUp}>
              <Container>
                <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-12">
          ...
          {/* Our Founder */}
          <section className="py-16 md:py-20 bg-gradient-to-b from-white to-slate-50/50" id="community-engagements">
            <motion.div {...fadeInUp}>
              <Container>
                <div className="max-w-7xl mx-auto">
                  <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Statistics */}
          <section className="py-16 md:py-20" style={{ background: `linear-gradient(135deg, ${BRAND_LIGHT} 0%, #e2e8f0 100%)` }} id="careers">
            <motion.div {...fadeInUp}>
              <Container>
                <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-12">
